...
def logs(str, f='./error.log'):
    #print str
    file(f,"a+").write(str+"\r")
...
class DB:
    ...
    def connect(self):
        if self.conn == None:
            ...
            #self.conn.unicode_literal.charset = 'utf8mb4'
            #self.conn.string_decoder.charset = 'utf8mb4'
    ...
    def execute(self, sql, args=None):
        ...
        try:
            ...
            logs('------ '+ time.strftime("%Y-%m-%d %H-%M-%S")+' Mysql execute error: '+sql+"="+str(json.dumps(args)))
        return self.cursor
