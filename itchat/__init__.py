...
# decorations
__functionDict = {'GroupChat': {}, 'GeneralReply': None, 'AutoReply':None}
def configured_reply():
    try:
        ...
        if __functionDict['AutoReply'] != None:
            autofun = __functionDict['AutoReply']
            autofun()

def msg_auto_reply(_type = None, *args, **kwargs):
    __functionDict['AutoReply'] = _type
    return True
